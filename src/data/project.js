...
const Projects = [
    {
        title: '待完善',
        description: '项目介绍有待将来完善',
        preview: 'https://s1.ax1x.com/2022/09/14/vxu1u8.png',
        website: '',
        source: '',
        tags: ['opensource', 'design', 'favorite'],
    },
];
const radomGetTagName = () => {
    return Object.keys(exports.Tags).filter(key => Math.random() > 0.5);
};
exports.TagList = Object.keys(exports.Tags);
function sortProject() {
    let result = new Array(12).fill(Projects[0]).map(item => ({
        ...item,
        tags: radomGetTagName()
    }));
    // Sort by site name
